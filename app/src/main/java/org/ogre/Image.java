...
public class Image {
  ...
  public Image loadDynamicImage(SWIGTYPE_p_unsigned_char data, long width, long height, PixelFormat format) {
    return new Image(OgreJNI.Image_loadDynamicImage__SWIG_4(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(data), width, height, format.swigValue()), false);
  }

  public Image loadRawData(DataStreamPtr stream, long width, long height, long depth, PixelFormat format, long numFaces, long numMipMaps) {
    return new Image(OgreJNI.Image_loadRawData__SWIG_0(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, width, height, depth, format.swigValue(), numFaces, numMipMaps), false);
  }

  public Image loadRawData(DataStreamPtr stream, long width, long height, long depth, PixelFormat format, long numFaces) {
    return new Image(OgreJNI.Image_loadRawData__SWIG_1(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, width, height, depth, format.swigValue(), numFaces), false);
  }

  public Image loadRawData(DataStreamPtr stream, long width, long height, long depth, PixelFormat format) {
    return new Image(OgreJNI.Image_loadRawData__SWIG_2(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, width, height, depth, format.swigValue()), false);
  }

  public Image loadRawData(DataStreamPtr stream, long width, long height, PixelFormat format) {
    return new Image(OgreJNI.Image_loadRawData__SWIG_3(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, width, height, format.swigValue()), false);
  }
  ...
  public Image load(DataStreamPtr stream, String type) {
    return new Image(OgreJNI.Image_load__SWIG_1(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, type), false);
  }

  public Image load(DataStreamPtr stream) {
    return new Image(OgreJNI.Image_load__SWIG_2(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream), false);
  }
  ...
  public Image loadTwoImagesAsRGBA(DataStreamPtr rgbStream, DataStreamPtr alphaStream, PixelFormat format, String rgbType, String alphaType) {
    return new Image(OgreJNI.Image_loadTwoImagesAsRGBA__SWIG_2(swigCPtr, this, DataStreamPtr.getCPtr(rgbStream), rgbStream, DataStreamPtr.getCPtr(alphaStream), alphaStream, format.swigValue(), rgbType, alphaType), false);
  }

  public Image loadTwoImagesAsRGBA(DataStreamPtr rgbStream, DataStreamPtr alphaStream, PixelFormat format, String rgbType) {
    return new Image(OgreJNI.Image_loadTwoImagesAsRGBA__SWIG_3(swigCPtr, this, DataStreamPtr.getCPtr(rgbStream), rgbStream, DataStreamPtr.getCPtr(alphaStream), alphaStream, format.swigValue(), rgbType), false);
  }

  public Image loadTwoImagesAsRGBA(DataStreamPtr rgbStream, DataStreamPtr alphaStream, PixelFormat format) {
    return new Image(OgreJNI.Image_loadTwoImagesAsRGBA__SWIG_4(swigCPtr, this, DataStreamPtr.getCPtr(rgbStream), rgbStream, DataStreamPtr.getCPtr(alphaStream), alphaStream, format.swigValue()), false);
  }

  public Image loadTwoImagesAsRGBA(DataStreamPtr rgbStream, DataStreamPtr alphaStream) {
    return new Image(OgreJNI.Image_loadTwoImagesAsRGBA__SWIG_5(swigCPtr, this, DataStreamPtr.getCPtr(rgbStream), rgbStream, DataStreamPtr.getCPtr(alphaStream), alphaStream), false);
  }
  ...
  public DataStreamPtr encode(String formatextension) {
    return new DataStreamPtr(OgreJNI.Image_encode(swigCPtr, this, formatextension), true);
  }
  ...
  public static String getFileExtFromMagic(DataStreamPtr stream) {
    return OgreJNI.Image_getFileExtFromMagic(DataStreamPtr.getCPtr(stream), stream);
  }
  ...
  public enum Filter {
    ...
    public static Filter swigToEnum(int swigValue) {
      Filter[] swigValues = Filter.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (Filter swigEnum : swigValues)
    ...
    @SuppressWarnings("unused")
    private Filter(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private Filter(Filter swigEnum) {
