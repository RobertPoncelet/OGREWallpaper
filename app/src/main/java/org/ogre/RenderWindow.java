...
public class RenderWindow extends RenderTarget {
  ...
  public void create(String name, long widthPt, long heightPt, boolean fullScreen, NameValuePairList miscParams) {
    OgreJNI.RenderWindow_create(swigCPtr, this, name, widthPt, heightPt, fullScreen, NameValuePairList.getCPtr(miscParams), miscParams);
  }
