...
public class Pass {
  ...
  public void setLineWidth(float width) {
    OgreJNI.Pass_setLineWidth(swigCPtr, this, width);
  }

  public float getLineWidth() {
    return OgreJNI.Pass_getLineWidth(swigCPtr, this);
  }
  ...
  public Vector4 getPointAttenuation() {
    return new Vector4(OgreJNI.Pass_getPointAttenuation(swigCPtr, this), false);
  }
  ...
  public ColourBlendState getBlendState() {
    return new ColourBlendState(OgreJNI.Pass_getBlendState(swigCPtr, this), false);
  }
  ...
  public void setColourWriteEnabled(boolean enabled) {
    OgreJNI.Pass_setColourWriteEnabled__SWIG_0(swigCPtr, this, enabled);
  }

  public boolean getColourWriteEnabled() {
    return OgreJNI.Pass_getColourWriteEnabled__SWIG_0(swigCPtr, this);
  }

  public void setColourWriteEnabled(boolean red, boolean green, boolean blue, boolean alpha) {
    OgreJNI.Pass_setColourWriteEnabled__SWIG_1(swigCPtr, this, red, green, blue, alpha);
  }

  public void getColourWriteEnabled(SWIGTYPE_p_bool red, SWIGTYPE_p_bool green, SWIGTYPE_p_bool blue, SWIGTYPE_p_bool alpha) {
    OgreJNI.Pass_getColourWriteEnabled__SWIG_1(swigCPtr, this, SWIGTYPE_p_bool.getCPtr(red), SWIGTYPE_p_bool.getCPtr(green), SWIGTYPE_p_bool.getCPtr(blue), SWIGTYPE_p_bool.getCPtr(alpha));
  }
  ...
  public GpuProgramPtr getGpuProgram(GpuProgramType programType) {
    return new GpuProgramPtr(OgreJNI.Pass_getGpuProgram(swigCPtr, this, programType.swigValue()), false);
  }
  ...
  public void setGpuProgram(GpuProgramType type, GpuProgramPtr prog, boolean resetParams) {
    OgreJNI.Pass_setGpuProgram__SWIG_0(swigCPtr, this, type.swigValue(), GpuProgramPtr.getCPtr(prog), prog, resetParams);
  }

  public void setGpuProgram(GpuProgramType type, GpuProgramPtr prog) {
    OgreJNI.Pass_setGpuProgram__SWIG_1(swigCPtr, this, type.swigValue(), GpuProgramPtr.getCPtr(prog), prog);
  }

  public void setGpuProgram(GpuProgramType type, String name, boolean resetParams) {
    OgreJNI.Pass_setGpuProgram__SWIG_2(swigCPtr, this, type.swigValue(), name, resetParams);
  }

  public void setGpuProgram(GpuProgramType type, String name) {
    OgreJNI.Pass_setGpuProgram__SWIG_3(swigCPtr, this, type.swigValue(), name);
  }
  ...
  public String getGpuProgramName(GpuProgramType type) {
    return OgreJNI.Pass_getGpuProgramName(swigCPtr, this, type.swigValue());
  }
  ...
  public void setGpuProgramParameters(GpuProgramType type, SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t params) {
    OgreJNI.Pass_setGpuProgramParameters(swigCPtr, this, type.swigValue(), SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t.getCPtr(params));
  }
  ...
  public SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t getGpuProgramParameters(GpuProgramType type) {
    return new SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t(OgreJNI.Pass_getGpuProgramParameters(swigCPtr, this, type.swigValue()), false);
  }
  ...
  public static SWIGTYPE_p_std__setT_Ogre__Pass_p_t getDirtyHashList() {
    return new SWIGTYPE_p_std__setT_Ogre__Pass_p_t(OgreJNI.Pass_getDirtyHashList(), false);
  }

  public static SWIGTYPE_p_std__setT_Ogre__Pass_p_t getPassGraveyard() {
    return new SWIGTYPE_p_std__setT_Ogre__Pass_p_t(OgreJNI.Pass_getPassGraveyard(), false);
  }
  ...
  public boolean applyTextureAliases(NameValuePairList aliasList, boolean apply) {
    return OgreJNI.Pass_applyTextureAliases__SWIG_0(swigCPtr, this, NameValuePairList.getCPtr(aliasList), aliasList, apply);
  }

  public boolean applyTextureAliases(NameValuePairList aliasList) {
    return OgreJNI.Pass_applyTextureAliases__SWIG_1(swigCPtr, this, NameValuePairList.getCPtr(aliasList), aliasList);
  }
  ...
  public enum BuiltinHashFunction {
    ...
    public static BuiltinHashFunction swigToEnum(int swigValue) {
      BuiltinHashFunction[] swigValues = BuiltinHashFunction.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (BuiltinHashFunction swigEnum : swigValues)
    ...
    private BuiltinHashFunction() {
      this.swigValue = SwigNext.next++;
    }

    @SuppressWarnings("unused")
    private BuiltinHashFunction(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private BuiltinHashFunction(BuiltinHashFunction swigEnum) {
