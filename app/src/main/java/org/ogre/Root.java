...
public class Root {
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__SceneManagerMetaData_const_p_t getSceneManagerMetaData() {
    return new SWIGTYPE_p_std__vectorT_Ogre__SceneManagerMetaData_const_p_t(OgreJNI.Root_getSceneManagerMetaData__SWIG_1(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__mapT_std__string_Ogre__SceneManager_p_t getSceneManagers() {
    return new SWIGTYPE_p_std__mapT_std__string_Ogre__SceneManager_p_t(OgreJNI.Root_getSceneManagers(swigCPtr, this), false);
  }
  ...
  public static DataStreamPtr createFileStream(String filename, String groupName, boolean overwrite, String locationPattern) {
    return new DataStreamPtr(OgreJNI.Root_createFileStream__SWIG_0(filename, groupName, overwrite, locationPattern), true);
  }

  public static DataStreamPtr createFileStream(String filename, String groupName, boolean overwrite) {
    return new DataStreamPtr(OgreJNI.Root_createFileStream__SWIG_1(filename, groupName, overwrite), true);
  }

  public static DataStreamPtr createFileStream(String filename, String groupName) {
    return new DataStreamPtr(OgreJNI.Root_createFileStream__SWIG_2(filename, groupName), true);
  }

  public static DataStreamPtr createFileStream(String filename) {
    return new DataStreamPtr(OgreJNI.Root_createFileStream__SWIG_3(filename), true);
  }

  public static DataStreamPtr openFileStream(String filename, String groupName) {
    return new DataStreamPtr(OgreJNI.Root_openFileStream__SWIG_0(filename, groupName), true);
  }

  public static DataStreamPtr openFileStream(String filename) {
    return new DataStreamPtr(OgreJNI.Root_openFileStream__SWIG_1(filename), true);
  }
  ...
  public RenderWindow createRenderWindow(String name, long width, long height, boolean fullScreen, NameValuePairList miscParams) {
    long cPtr = OgreJNI.Root_createRenderWindow__SWIG_0(swigCPtr, this, name, width, height, fullScreen, NameValuePairList.getCPtr(miscParams), miscParams);
    return (cPtr == 0) ? null : new RenderWindow(cPtr, false);
  }
  ...
  public RenderWindow createRenderWindow(RenderWindowDescription desc) {
    long cPtr = OgreJNI.Root_createRenderWindow__SWIG_2(swigCPtr, this, RenderWindowDescription.getCPtr(desc), desc);
    return (cPtr == 0) ? null : new RenderWindow(cPtr, false);
  }

  public boolean createRenderWindows(SWIGTYPE_p_std__vectorT_Ogre__RenderWindowDescription_t renderWindowDescriptions, SWIGTYPE_p_std__vectorT_Ogre__RenderWindow_p_t createdWindows) {
    return OgreJNI.Root_createRenderWindows(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__RenderWindowDescription_t.getCPtr(renderWindowDescriptions), SWIGTYPE_p_std__vectorT_Ogre__RenderWindow_p_t.getCPtr(createdWindows));
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__Plugin_p_t getInstalledPlugins() {
    return new SWIGTYPE_p_std__vectorT_Ogre__Plugin_p_t(OgreJNI.Root_getInstalledPlugins(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__mapT_std__string_Ogre__MovableObjectFactory_p_t getMovableObjectFactories() {
    return new SWIGTYPE_p_std__mapT_std__string_Ogre__MovableObjectFactory_p_t(OgreJNI.Root_getMovableObjectFactories(swigCPtr, this), false);
  }
