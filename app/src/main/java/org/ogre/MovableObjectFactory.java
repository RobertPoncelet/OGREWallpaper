...
public class MovableObjectFactory {
  ...
  public MovableObject createInstance(String name, SceneManager manager, NameValuePairList params) {
    long cPtr = OgreJNI.MovableObjectFactory_createInstance__SWIG_0(swigCPtr, this, name, SceneManager.getCPtr(manager), manager, NameValuePairList.getCPtr(params), params);
