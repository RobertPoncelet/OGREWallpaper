...
public class CompositorChain extends RenderTargetListener {
  ...
  public long getCompositorPosition(String name) {
    return OgreJNI.CompositorChain_getCompositorPosition(swigCPtr, this, name);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__CompositorInstance_p_t getCompositorInstances() {
    return new SWIGTYPE_p_std__vectorT_Ogre__CompositorInstance_p_t(OgreJNI.CompositorChain_getCompositorInstances(swigCPtr, this), false);
  }
  ...
  public final static int BEST = OgreJNI.CompositorChain_BEST_get();
  public final static int LAST = OgreJNI.CompositorChain_LAST_get();
  public final static int NPOS = OgreJNI.CompositorChain_NPOS_get();
