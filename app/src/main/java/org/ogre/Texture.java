...
public class Texture extends Resource {
  ...
  public void loadRawData(DataStreamPtr stream, int uWidth, int uHeight, PixelFormat eFormat) {
    OgreJNI.Texture_loadRawData(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, uWidth, uHeight, eFormat.swigValue());
  }

  public void _loadImages(SWIGTYPE_p_std__vectorT_Ogre__Image_const_p_t images) {
    OgreJNI.Texture__loadImages(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__Image_const_p_t.getCPtr(images));
  }
  ...
  public HardwarePixelBufferPtr getBuffer(long face, long mipmap) {
    return new HardwarePixelBufferPtr(OgreJNI.Texture_getBuffer__SWIG_0(swigCPtr, this, face, mipmap), false);
  }

  public HardwarePixelBufferPtr getBuffer(long face) {
    return new HardwarePixelBufferPtr(OgreJNI.Texture_getBuffer__SWIG_1(swigCPtr, this, face), false);
  }

  public HardwarePixelBufferPtr getBuffer() {
    return new HardwarePixelBufferPtr(OgreJNI.Texture_getBuffer__SWIG_2(swigCPtr, this), false);
  }
  ...
  public void getCustomAttribute(String name, SWIGTYPE_p_void pData) {
    OgreJNI.Texture_getCustomAttribute__SWIG_0(swigCPtr, this, name, SWIGTYPE_p_void.getCPtr(pData));
  }

  public long getCustomAttribute(String name) {
    return OgreJNI.Texture_getCustomAttribute__SWIG_1(swigCPtr, this, name);
  }
  ...
  public void createShaderAccessPoint(long bindPoint, TextureAccess access, int mipmapLevel, int textureArrayIndex, PixelFormat format) {
    OgreJNI.Texture_createShaderAccessPoint__SWIG_0(swigCPtr, this, bindPoint, access.swigValue(), mipmapLevel, textureArrayIndex, format.swigValue());
  }
  ...
  public void setLayerNames(StringVector names) {
    OgreJNI.Texture_setLayerNames(swigCPtr, this, StringVector.getCPtr(names), names);
  }
