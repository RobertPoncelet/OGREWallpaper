...
public class VertexAnimationTrack extends AnimationTrack {
  ...
  public enum TargetMode {
    ...
    public static TargetMode swigToEnum(int swigValue) {
      TargetMode[] swigValues = TargetMode.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (TargetMode swigEnum : swigValues)
    ...
    @SuppressWarnings("unused")
    private TargetMode(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private TargetMode(TargetMode swigEnum) {
