...
public class StringVector {
  ...
  public StringVector(long n) {
    this(OgreJNI.new_StringVector__SWIG_1(n), true);
  }

  public long size() {
    return OgreJNI.StringVector_size(swigCPtr, this);
  }
  ...
  public void add(String x) {
    OgreJNI.StringVector_add(swigCPtr, this, x);
  }

  public String get(int i) {
    return OgreJNI.StringVector_get(swigCPtr, this, i);
  }

  public void set(int i, String val) {
    OgreJNI.StringVector_set(swigCPtr, this, i, val);
  }
