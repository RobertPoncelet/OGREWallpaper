...
public class PlaneBoundedVolume {
  ...
  public void setPlanes(SWIGTYPE_p_std__vectorT_Ogre__Plane_t value) {
    OgreJNI.PlaneBoundedVolume_planes_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__Plane_t.getCPtr(value));
  }
  ...
  public RayTestResult intersects(Ray ray) {
    return new RayTestResult(OgreJNI.PlaneBoundedVolume_intersects__SWIG_2(swigCPtr, this, Ray.getCPtr(ray), ray), true);
  }
