...
public class BillboardSet extends MovableObject {
  ...
  public void setTextureCoords(SWIGTYPE_p_std__vectorT_Ogre__TRectT_float_t_t coords) {
    OgreJNI.BillboardSet_setTextureCoords__SWIG_0(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__TRectT_float_t_t.getCPtr(coords));
  }

  public void setTextureCoords(FloatRect coords, int numCoords) {
    OgreJNI.BillboardSet_setTextureCoords__SWIG_1(swigCPtr, this, FloatRect.getCPtr(coords), coords, numCoords);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__TRectT_float_t_t getTextureCoords() {
    return new SWIGTYPE_p_std__vectorT_Ogre__TRectT_float_t_t(OgreJNI.BillboardSet_getTextureCoords__SWIG_0(swigCPtr, this), false);
  }

  public FloatRect getTextureCoords(SWIGTYPE_p_unsigned_short oNumCoords) {
    long cPtr = OgreJNI.BillboardSet_getTextureCoords__SWIG_1(swigCPtr, this, SWIGTYPE_p_unsigned_short.getCPtr(oNumCoords));
