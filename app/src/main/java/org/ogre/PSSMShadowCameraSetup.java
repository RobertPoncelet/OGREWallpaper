...
public class PSSMShadowCameraSetup extends LiSPSMShadowCameraSetup {
  ...
  public static ShadowCameraSetupPtr create() {
    return new ShadowCameraSetupPtr(OgreJNI.PSSMShadowCameraSetup_create(), true);
  }
  ...
  public void setSplitPoints(SWIGTYPE_p_std__vectorT_float_t newSplitPoints) {
    OgreJNI.PSSMShadowCameraSetup_setSplitPoints(swigCPtr, this, SWIGTYPE_p_std__vectorT_float_t.getCPtr(newSplitPoints));
  }
  ...
  public SWIGTYPE_p_std__vectorT_float_t getSplitPoints() {
    return new SWIGTYPE_p_std__vectorT_float_t(OgreJNI.PSSMShadowCameraSetup_getSplitPoints(swigCPtr, this), false);
  }
