...
public class ColourValue {
  ...
  public ColourValue __add__(ColourValue rkVector) {
    return new ColourValue(OgreJNI.ColourValue___add__(swigCPtr, this, ColourValue.getCPtr(rkVector), rkVector), true);
  }

  public ColourValue __sub__(ColourValue rkVector) {
    return new ColourValue(OgreJNI.ColourValue___sub__(swigCPtr, this, ColourValue.getCPtr(rkVector), rkVector), true);
  }

  public ColourValue __mul__(float fScalar) {
    return new ColourValue(OgreJNI.ColourValue___mul____SWIG_0(swigCPtr, this, fScalar), true);
  }

  public ColourValue __mul__(ColourValue rhs) {
    return new ColourValue(OgreJNI.ColourValue___mul____SWIG_1(swigCPtr, this, ColourValue.getCPtr(rhs), rhs), true);
  }

  public ColourValue __div__(ColourValue rhs) {
    return new ColourValue(OgreJNI.ColourValue___div____SWIG_0(swigCPtr, this, ColourValue.getCPtr(rhs), rhs), true);
  }

  public ColourValue __div__(float fScalar) {
    return new ColourValue(OgreJNI.ColourValue___div____SWIG_1(swigCPtr, this, fScalar), true);
  }
  ...
  public void getHSB(SWIGTYPE_p_float hue, SWIGTYPE_p_float saturation, SWIGTYPE_p_float brightness) {
    OgreJNI.ColourValue_getHSB__SWIG_0(swigCPtr, this, SWIGTYPE_p_float.getCPtr(hue), SWIGTYPE_p_float.getCPtr(saturation), SWIGTYPE_p_float.getCPtr(brightness));
  }
