...
public class Compositor extends Resource {
  ...
  public Compositor(ResourceManager creator, String name, long handle, String group, boolean isManual, ManualResourceLoader loader) {
  ...
  public Compositor(ResourceManager creator, String name, long handle, String group, boolean isManual) {
    this(OgreJNI.new_Compositor__SWIG_1(ResourceManager.getCPtr(creator), creator, name, handle, group, isManual), true);
  }

  public Compositor(ResourceManager creator, String name, long handle, String group) {
  ...
  public TexturePtr getTextureInstance(String name, long mrtIndex) {
    return new TexturePtr(OgreJNI.Compositor_getTextureInstance(swigCPtr, this, name, mrtIndex), false);
  }
