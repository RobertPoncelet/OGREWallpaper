...
public class Math {
  ...
  public static int uint16Cast(long t) {
    return OgreJNI.Math_uint16Cast(t);
  }
  ...
  public static RayTestResult intersects(Ray ray, Plane plane) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_0(Ray.getCPtr(ray), ray, Plane.getCPtr(plane), plane), true);
  }

  public static RayTestResult intersects(Ray ray, Sphere sphere, boolean discardInside) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_1(Ray.getCPtr(ray), ray, Sphere.getCPtr(sphere), sphere, discardInside), true);
  }

  public static RayTestResult intersects(Ray ray, Sphere sphere) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_2(Ray.getCPtr(ray), ray, Sphere.getCPtr(sphere), sphere), true);
  }

  public static RayTestResult intersects(Ray ray, AxisAlignedBox box) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_3(Ray.getCPtr(ray), ray, AxisAlignedBox.getCPtr(box), box), true);
  }
  ...
  public static RayTestResult intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, Vector3 normal, boolean positiveSide, boolean negativeSide) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_5(Ray.getCPtr(ray), ray, Vector3.getCPtr(a), a, Vector3.getCPtr(b), b, Vector3.getCPtr(c), c, Vector3.getCPtr(normal), normal, positiveSide, negativeSide), true);
  }

  public static RayTestResult intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, Vector3 normal, boolean positiveSide) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_6(Ray.getCPtr(ray), ray, Vector3.getCPtr(a), a, Vector3.getCPtr(b), b, Vector3.getCPtr(c), c, Vector3.getCPtr(normal), normal, positiveSide), true);
  }

  public static RayTestResult intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, Vector3 normal) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_7(Ray.getCPtr(ray), ray, Vector3.getCPtr(a), a, Vector3.getCPtr(b), b, Vector3.getCPtr(c), c, Vector3.getCPtr(normal), normal), true);
  }

  public static RayTestResult intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, boolean positiveSide, boolean negativeSide) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_8(Ray.getCPtr(ray), ray, Vector3.getCPtr(a), a, Vector3.getCPtr(b), b, Vector3.getCPtr(c), c, positiveSide, negativeSide), true);
  }

  public static RayTestResult intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c, boolean positiveSide) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_9(Ray.getCPtr(ray), ray, Vector3.getCPtr(a), a, Vector3.getCPtr(b), b, Vector3.getCPtr(c), c, positiveSide), true);
  }

  public static RayTestResult intersects(Ray ray, Vector3 a, Vector3 b, Vector3 c) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_10(Ray.getCPtr(ray), ray, Vector3.getCPtr(a), a, Vector3.getCPtr(b), b, Vector3.getCPtr(c), c), true);
  }
  ...
  public static RayTestResult intersects(Ray ray, SWIGTYPE_p_std__vectorT_Ogre__Plane_t planeList, boolean normalIsOutside) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_13(Ray.getCPtr(ray), ray, SWIGTYPE_p_std__vectorT_Ogre__Plane_t.getCPtr(planeList), normalIsOutside), true);
  }

  public static RayTestResult intersects(Ray ray, SWIGTYPE_p_std__listT_Ogre__Plane_t planeList, boolean normalIsOutside) {
    return new RayTestResult(OgreJNI.Math_intersects__SWIG_14(Ray.getCPtr(ray), ray, SWIGTYPE_p_std__listT_Ogre__Plane_t.getCPtr(planeList), normalIsOutside), true);
  }
  ...
  public static Affine3 buildReflectionMatrix(Plane p) {
    return new Affine3(OgreJNI.Math_buildReflectionMatrix(Plane.getCPtr(p), p), true);
  }
  ...
  public static Affine3 makeViewMatrix(Vector3 position, Quaternion orientation, Affine3 reflectMatrix) {
    return new Affine3(OgreJNI.Math_makeViewMatrix__SWIG_0(Vector3.getCPtr(position), position, Quaternion.getCPtr(orientation), orientation, Affine3.getCPtr(reflectMatrix), reflectMatrix), true);
  }

  public static Affine3 makeViewMatrix(Vector3 position, Quaternion orientation) {
    return new Affine3(OgreJNI.Math_makeViewMatrix__SWIG_1(Vector3.getCPtr(position), position, Quaternion.getCPtr(orientation), orientation), true);
  }

  public static Matrix3 lookRotation(Vector3 direction, Vector3 yaw) {
    return new Matrix3(OgreJNI.Math_lookRotation(Vector3.getCPtr(direction), direction, Vector3.getCPtr(yaw), yaw), true);
  }

  public static Matrix4 makePerspectiveMatrix(float left, float right, float bottom, float top, float zNear, float zFar) {
    return new Matrix4(OgreJNI.Math_makePerspectiveMatrix(left, right, bottom, top, zNear, zFar), true);
  }
