...
public class ControllerManager {
  ...
  public ControllerReal createController(ControllerValueRealPtr src, ControllerValueRealPtr dest, ControllerFunctionPtr func) {
    long cPtr = OgreJNI.ControllerManager_createController(swigCPtr, this, ControllerValueRealPtr.getCPtr(src), src, ControllerValueRealPtr.getCPtr(dest), dest, ControllerFunctionPtr.getCPtr(func), func);
  ...
  public ControllerReal createFrameTimePassthroughController(ControllerValueRealPtr dest) {
    long cPtr = OgreJNI.ControllerManager_createFrameTimePassthroughController(swigCPtr, this, ControllerValueRealPtr.getCPtr(dest), dest);
    return (cPtr == 0) ? null : new ControllerReal(cPtr, false);
  }
  ...
  public ControllerValueRealPtr getFrameTimeSource() {
    return new ControllerValueRealPtr(OgreJNI.ControllerManager_getFrameTimeSource(swigCPtr, this), false);
  }

  public ControllerFunctionPtr getPassthroughControllerFunction() {
    return new ControllerFunctionPtr(OgreJNI.ControllerManager_getPassthroughControllerFunction(swigCPtr, this), false);
  }
  ...
  public ControllerReal createTextureWaveTransformer(TextureUnitState layer, TextureUnitState.TextureTransformType ttype, WaveformType waveType, float base, float frequency, float phase, float amplitude) {
  ...
  public ControllerReal createTextureWaveTransformer(TextureUnitState layer, TextureUnitState.TextureTransformType ttype, WaveformType waveType, float base, float frequency, float phase) {
  ...
  public ControllerReal createTextureWaveTransformer(TextureUnitState layer, TextureUnitState.TextureTransformType ttype, WaveformType waveType, float base, float frequency) {
  ...
  public ControllerReal createTextureWaveTransformer(TextureUnitState layer, TextureUnitState.TextureTransformType ttype, WaveformType waveType, float base) {
  ...
  public ControllerReal createGpuProgramTimerParam(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t params, long paramIndex, float timeFactor) {
  ...
  public ControllerReal createGpuProgramTimerParam(SWIGTYPE_p_Ogre__SharedPtrT_Ogre__GpuProgramParameters_t params, long paramIndex) {
  ...
  public void destroyController(ControllerReal controller) {
    OgreJNI.ControllerManager_destroyController(swigCPtr, this, ControllerReal.getCPtr(controller), controller);
  }
