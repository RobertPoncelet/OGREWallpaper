...
public class AnimationTrack {
  ...
  static public class Listener {
    ...
    public Listener() {
      ...
      OgreJNI.AnimationTrack_Listener_director_connect(this, swigCPtr, swigCMemOwn, true);
    }
  ...
  public void _collectKeyFrameTimes(SWIGTYPE_p_std__vectorT_float_t keyFrameTimes) {
    OgreJNI.AnimationTrack__collectKeyFrameTimes(swigCPtr, this, SWIGTYPE_p_std__vectorT_float_t.getCPtr(keyFrameTimes));
  }

  public void _buildKeyFrameIndexMap(SWIGTYPE_p_std__vectorT_float_t keyFrameTimes) {
    OgreJNI.AnimationTrack__buildKeyFrameIndexMap(swigCPtr, this, SWIGTYPE_p_std__vectorT_float_t.getCPtr(keyFrameTimes));
  }
