...
public class Mesh extends Resource {
  ...
  public Mesh(ResourceManager creator, String name, long handle, String group, boolean isManual, ManualResourceLoader loader) {
  ...
  public Mesh(ResourceManager creator, String name, long handle, String group, boolean isManual) {
    this(OgreJNI.new_Mesh__SWIG_1(ResourceManager.getCPtr(creator), creator, name, handle, group, isManual), true);
  }

  public Mesh(ResourceManager creator, String name, long handle, String group) {
  ...
  public void setLodStrategy(LodStrategy lodStrategy) {
    OgreJNI.Mesh_setLodStrategy(swigCPtr, this, LodStrategy.getCPtr(lodStrategy), lodStrategy);
  }
