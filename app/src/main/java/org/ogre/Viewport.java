...
public class Viewport {
  ...
  static public class Listener {
    ...
    public Listener() {
      ...
      OgreJNI.Viewport_Listener_director_connect(this, swigCPtr, swigCMemOwn, true);
    }
  ...
  public Rect getActualDimensions() {
    return new Rect(OgreJNI.Viewport_getActualDimensions__SWIG_0(swigCPtr, this), true);
  }

  public void getActualDimensions(SWIGTYPE_p_int left, SWIGTYPE_p_int top, SWIGTYPE_p_int width, SWIGTYPE_p_int height) {
    OgreJNI.Viewport_getActualDimensions__SWIG_1(swigCPtr, this, SWIGTYPE_p_int.getCPtr(left), SWIGTYPE_p_int.getCPtr(top), SWIGTYPE_p_int.getCPtr(width), SWIGTYPE_p_int.getCPtr(height));
  }
