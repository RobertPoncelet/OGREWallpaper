...
public class MaterialManager extends ResourceManager {
  ...
  static public class MaterialManager_Listener {
    private transient long swigCPtr;
    ...
    public synchronized void delete() {
      if (swigCPtr != 0) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          OgreJNI.delete_MaterialManager_MaterialManager_Listener(swigCPtr);
        }
        swigCPtr = 0;
      }
    }
    ...
    public void swigReleaseOwnership() {
      swigCMemOwn = false;
      OgreJNI.MaterialManager_MaterialManager_Listener_change_ownership(this, swigCPtr, false);
    }
  
    public void swigTakeOwnership() {
      swigCMemOwn = true;
      OgreJNI.MaterialManager_MaterialManager_Listener_change_ownership(this, swigCPtr, true);
    }
    ...
    public Technique handleSchemeNotFound(int schemeIndex, String schemeName, Material originalMaterial, int lodIndex, Renderable rend) {
      long cPtr = OgreJNI.MaterialManager_MaterialManager_Listener_handleSchemeNotFound(swigCPtr, this, schemeIndex, schemeName, Material.getCPtr(originalMaterial), originalMaterial, lodIndex, Renderable.getCPtr(rend), rend);
      return (cPtr == 0) ? null : new Technique(cPtr, false);
    }
  
    public boolean afterIlluminationPassesCreated(Technique technique) {
      return (getClass() == MaterialManager_Listener.class) ? OgreJNI.MaterialManager_MaterialManager_Listener_afterIlluminationPassesCreated(swigCPtr, this, Technique.getCPtr(technique), technique) : OgreJNI.MaterialManager_MaterialManager_Listener_afterIlluminationPassesCreatedSwigExplicitMaterialManager_Listener(swigCPtr, this, Technique.getCPtr(technique), technique);
    }
  
    public boolean beforeIlluminationPassesCleared(Technique technique) {
      return (getClass() == MaterialManager_Listener.class) ? OgreJNI.MaterialManager_MaterialManager_Listener_beforeIlluminationPassesCleared(swigCPtr, this, Technique.getCPtr(technique), technique) : OgreJNI.MaterialManager_MaterialManager_Listener_beforeIlluminationPassesClearedSwigExplicitMaterialManager_Listener(swigCPtr, this, Technique.getCPtr(technique), technique);
    }
  
    public MaterialManager_Listener() {
      this(OgreJNI.new_MaterialManager_Listener(), true);
      OgreJNI.MaterialManager_MaterialManager_Listener_director_connect(this, swigCPtr, swigCMemOwn, true);
    }
  ...
  public void addListener(MaterialManager.MaterialManager_Listener l, String schemeName) {
    OgreJNI.MaterialManager_addListener__SWIG_0(swigCPtr, this, MaterialManager.MaterialManager_Listener.getCPtr(l), l, schemeName);
  }

  public void addListener(MaterialManager.MaterialManager_Listener l) {
    OgreJNI.MaterialManager_addListener__SWIG_1(swigCPtr, this, MaterialManager.MaterialManager_Listener.getCPtr(l), l);
  }

  public void removeListener(MaterialManager.MaterialManager_Listener l, String schemeName) {
    OgreJNI.MaterialManager_removeListener__SWIG_0(swigCPtr, this, MaterialManager.MaterialManager_Listener.getCPtr(l), l, schemeName);
  }

  public void removeListener(MaterialManager.MaterialManager_Listener l) {
    OgreJNI.MaterialManager_removeListener__SWIG_1(swigCPtr, this, MaterialManager.MaterialManager_Listener.getCPtr(l), l);
  }
