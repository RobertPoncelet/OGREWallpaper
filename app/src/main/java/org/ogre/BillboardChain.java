...
public class BillboardChain extends MovableObject {
  ...
  public enum TexCoordDirection {
    ...
    public static TexCoordDirection swigToEnum(int swigValue) {
      TexCoordDirection[] swigValues = TexCoordDirection.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (TexCoordDirection swigEnum : swigValues)
    ...
    private TexCoordDirection() {
      this.swigValue = SwigNext.next++;
    }

    @SuppressWarnings("unused")
    private TexCoordDirection(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private TexCoordDirection(TexCoordDirection swigEnum) {
