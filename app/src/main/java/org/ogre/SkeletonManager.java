...
public class SkeletonManager extends ResourceManager {
  ...
  public SkeletonPtr create(String name, String group, boolean isManual, ManualResourceLoader loader, NameValuePairList createParams) {
    return new SkeletonPtr(OgreJNI.SkeletonManager_create__SWIG_0(swigCPtr, this, name, group, isManual, ManualResourceLoader.getCPtr(loader), loader, NameValuePairList.getCPtr(createParams), createParams), true);
  }
  ...
  public SkeletonPtr getByName(String name, String groupName) {
    return new SkeletonPtr(OgreJNI.SkeletonManager_getByName__SWIG_0(swigCPtr, this, name, groupName), true);
  }

  public SkeletonPtr getByName(String name) {
    return new SkeletonPtr(OgreJNI.SkeletonManager_getByName__SWIG_1(swigCPtr, this, name), true);
  }
