...
public class SceneManager {
  ...
  static public class Listener {
    ...
    public Listener() {
      ...
      OgreJNI.SceneManager_Listener_director_connect(this, swigCPtr, swigCMemOwn, true);
    }
  ...
  static public class SceneMgrQueuedRenderableVisitor extends QueuedRenderableVisitor {
    ...
    public void visit(Pass p, SWIGTYPE_p_std__vectorT_Ogre__Renderable_p_t rs) {
      OgreJNI.SceneManager_SceneMgrQueuedRenderableVisitor_visit__SWIG_0(swigCPtr, this, Pass.getCPtr(p), p, SWIGTYPE_p_std__vectorT_Ogre__Renderable_p_t.getCPtr(rs));
    }
  
    public void visit(RenderablePass rp) {
      OgreJNI.SceneManager_SceneMgrQueuedRenderableVisitor_visit__SWIG_1(swigCPtr, this, RenderablePass.getCPtr(rp), rp);
    }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__Plane_t getLightClippingPlanes(Light l) {
    return new SWIGTYPE_p_std__vectorT_Ogre__Plane_t(OgreJNI.SceneManager_getLightClippingPlanes(swigCPtr, this, Light.getCPtr(l), l), false);
  }

  public FloatRect getLightScissorRect(Light l, Camera cam) {
    return new FloatRect(OgreJNI.SceneManager_getLightScissorRect(swigCPtr, this, Light.getCPtr(l), l, Camera.getCPtr(cam), cam), false);
  }
  ...
  public SceneNode getSceneNode(String name, boolean throwExceptionIfNotFound) {
    long cPtr = OgreJNI.SceneManager_getSceneNode__SWIG_0(swigCPtr, this, name, throwExceptionIfNotFound);
    return (cPtr == 0) ? null : new SceneNode(cPtr, false);
  }

  public SceneNode getSceneNode(String name) {
    long cPtr = OgreJNI.SceneManager_getSceneNode__SWIG_1(swigCPtr, this, name);
    return (cPtr == 0) ? null : new SceneNode(cPtr, false);
  }
  ...
  public void prepareWorldGeometry(DataStreamPtr stream, String typeName) {
    OgreJNI.SceneManager_prepareWorldGeometry__SWIG_1(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, typeName);
  }

  public void prepareWorldGeometry(DataStreamPtr stream) {
    OgreJNI.SceneManager_prepareWorldGeometry__SWIG_2(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream);
  }
  ...
  public void setWorldGeometry(DataStreamPtr stream, String typeName) {
    OgreJNI.SceneManager_setWorldGeometry__SWIG_1(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, typeName);
  }

  public void setWorldGeometry(DataStreamPtr stream) {
    OgreJNI.SceneManager_setWorldGeometry__SWIG_2(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream);
  }
  ...
  public long estimateWorldGeometry(DataStreamPtr stream, String typeName) {
    return OgreJNI.SceneManager_estimateWorldGeometry__SWIG_1(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream, typeName);
  }

  public long estimateWorldGeometry(DataStreamPtr stream) {
    return OgreJNI.SceneManager_estimateWorldGeometry__SWIG_2(swigCPtr, this, DataStreamPtr.getCPtr(stream), stream);
  }
  ...
  public void manualRender(RenderOperation rend, Pass pass, Viewport vp, Affine3 worldMatrix, Affine3 viewMatrix, Matrix4 projMatrix, boolean doBeginEndFrame) {
    OgreJNI.SceneManager_manualRender__SWIG_0(swigCPtr, this, RenderOperation.getCPtr(rend), rend, Pass.getCPtr(pass), pass, Viewport.getCPtr(vp), vp, Affine3.getCPtr(worldMatrix), worldMatrix, Affine3.getCPtr(viewMatrix), viewMatrix, Matrix4.getCPtr(projMatrix), projMatrix, doBeginEndFrame);
  }
  ...
  public void manualRender(RenderOperation rend, Pass pass, Viewport vp, Affine3 worldMatrix, Affine3 viewMatrix, Matrix4 projMatrix) {
    OgreJNI.SceneManager_manualRender__SWIG_1(swigCPtr, this, RenderOperation.getCPtr(rend), rend, Pass.getCPtr(pass), pass, Viewport.getCPtr(vp), vp, Affine3.getCPtr(worldMatrix), worldMatrix, Affine3.getCPtr(viewMatrix), viewMatrix, Matrix4.getCPtr(projMatrix), projMatrix);
  }

  public void manualRender(Renderable rend, Pass pass, Viewport vp, Affine3 viewMatrix, Matrix4 projMatrix, boolean doBeginEndFrame, boolean lightScissoringClipping, boolean doLightIteration, SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t manualLightList) {
    OgreJNI.SceneManager_manualRender__SWIG_2(swigCPtr, this, Renderable.getCPtr(rend), rend, Pass.getCPtr(pass), pass, Viewport.getCPtr(vp), vp, Affine3.getCPtr(viewMatrix), viewMatrix, Matrix4.getCPtr(projMatrix), projMatrix, doBeginEndFrame, lightScissoringClipping, doLightIteration, SWIGTYPE_p_Ogre__HashedVectorT_Ogre__Light_p_t.getCPtr(manualLightList));
  }

  public void manualRender(Renderable rend, Pass pass, Viewport vp, Affine3 viewMatrix, Matrix4 projMatrix, boolean doBeginEndFrame, boolean lightScissoringClipping, boolean doLightIteration) {
    OgreJNI.SceneManager_manualRender__SWIG_3(swigCPtr, this, Renderable.getCPtr(rend), rend, Pass.getCPtr(pass), pass, Viewport.getCPtr(vp), vp, Affine3.getCPtr(viewMatrix), viewMatrix, Matrix4.getCPtr(projMatrix), projMatrix, doBeginEndFrame, lightScissoringClipping, doLightIteration);
  }

  public void manualRender(Renderable rend, Pass pass, Viewport vp, Affine3 viewMatrix, Matrix4 projMatrix, boolean doBeginEndFrame, boolean lightScissoringClipping) {
    OgreJNI.SceneManager_manualRender__SWIG_4(swigCPtr, this, Renderable.getCPtr(rend), rend, Pass.getCPtr(pass), pass, Viewport.getCPtr(vp), vp, Affine3.getCPtr(viewMatrix), viewMatrix, Matrix4.getCPtr(projMatrix), projMatrix, doBeginEndFrame, lightScissoringClipping);
  }

  public void manualRender(Renderable rend, Pass pass, Viewport vp, Affine3 viewMatrix, Matrix4 projMatrix, boolean doBeginEndFrame) {
    OgreJNI.SceneManager_manualRender__SWIG_5(swigCPtr, this, Renderable.getCPtr(rend), rend, Pass.getCPtr(pass), pass, Viewport.getCPtr(vp), vp, Affine3.getCPtr(viewMatrix), viewMatrix, Matrix4.getCPtr(projMatrix), projMatrix, doBeginEndFrame);
  }

  public void manualRender(Renderable rend, Pass pass, Viewport vp, Affine3 viewMatrix, Matrix4 projMatrix) {
    OgreJNI.SceneManager_manualRender__SWIG_6(swigCPtr, this, Renderable.getCPtr(rend), rend, Pass.getCPtr(pass), pass, Viewport.getCPtr(vp), vp, Affine3.getCPtr(viewMatrix), viewMatrix, Matrix4.getCPtr(projMatrix), projMatrix);
  }
  ...
  public PlaneBoundedVolumeListSceneQuery createPlaneBoundedVolumeQuery(SWIGTYPE_p_std__vectorT_Ogre__PlaneBoundedVolume_t volumes, long mask) {
    long cPtr = OgreJNI.SceneManager_createPlaneBoundedVolumeQuery__SWIG_0(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__PlaneBoundedVolume_t.getCPtr(volumes), mask);
    return (cPtr == 0) ? null : new PlaneBoundedVolumeListSceneQuery(cPtr, false);
  }

  public PlaneBoundedVolumeListSceneQuery createPlaneBoundedVolumeQuery(SWIGTYPE_p_std__vectorT_Ogre__PlaneBoundedVolume_t volumes) {
    long cPtr = OgreJNI.SceneManager_createPlaneBoundedVolumeQuery__SWIG_1(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__PlaneBoundedVolume_t.getCPtr(volumes));
    return (cPtr == 0) ? null : new PlaneBoundedVolumeListSceneQuery(cPtr, false);
  }
  ...
  public RaySceneQuery createRayQuery(Ray ray, long mask) {
    ...
    return (cPtr == 0) ? null : new RaySceneQuery(cPtr, true);
  }
  ...
  public SWIGTYPE_p_std__mapT_std__string_Ogre__Camera_p_t getCameras() {
    return new SWIGTYPE_p_std__mapT_std__string_Ogre__Camera_p_t(OgreJNI.SceneManager_getCameras(swigCPtr, this), false);
  }

  public SWIGTYPE_p_std__mapT_std__string_Ogre__Animation_p_t getAnimations() {
    return new SWIGTYPE_p_std__mapT_std__string_Ogre__Animation_p_t(OgreJNI.SceneManager_getAnimations(swigCPtr, this), false);
  }

  public AnimationStateMap getAnimationStates() {
    return new AnimationStateMap(OgreJNI.SceneManager_getAnimationStates(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__ShadowTextureConfig_t getShadowTextureConfigList() {
    return new SWIGTYPE_p_std__vectorT_Ogre__ShadowTextureConfig_t(OgreJNI.SceneManager_getShadowTextureConfigList(swigCPtr, this), false);
  }
  ...
  public MovableObject createMovableObject(String name, String typeName, NameValuePairList params) {
    long cPtr = OgreJNI.SceneManager_createMovableObject__SWIG_0(swigCPtr, this, name, typeName, NameValuePairList.getCPtr(params), params);
  ...
  public MovableObject createMovableObject(String typeName, NameValuePairList params) {
    long cPtr = OgreJNI.SceneManager_createMovableObject__SWIG_2(swigCPtr, this, typeName, NameValuePairList.getCPtr(params), params);
    return (cPtr == 0) ? null : new MovableObject(cPtr, false);
  }
  ...
  public SWIGTYPE_p_std__mapT_std__string_Ogre__MovableObject_p_t getMovableObjects(String typeName) {
    return new SWIGTYPE_p_std__mapT_std__string_Ogre__MovableObject_p_t(OgreJNI.SceneManager_getMovableObjects(swigCPtr, this, typeName), false);
  }
  ...
  public SWIGTYPE_p_Ogre__AutoParamDataSource _getAutoParamDataSource() {
    long cPtr = OgreJNI.SceneManager__getAutoParamDataSource(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_Ogre__AutoParamDataSource(cPtr, false);
  }

  public enum QueryTypeMask {
    WORLD_GEOMETRY_TYPE_MASK(OgreJNI.SceneManager_WORLD_GEOMETRY_TYPE_MASK_get()),
    ENTITY_TYPE_MASK(OgreJNI.SceneManager_ENTITY_TYPE_MASK_get()),
    FX_TYPE_MASK(OgreJNI.SceneManager_FX_TYPE_MASK_get()),
    STATICGEOMETRY_TYPE_MASK(OgreJNI.SceneManager_STATICGEOMETRY_TYPE_MASK_get()),
    LIGHT_TYPE_MASK(OgreJNI.SceneManager_LIGHT_TYPE_MASK_get()),
    FRUSTUM_TYPE_MASK(OgreJNI.SceneManager_FRUSTUM_TYPE_MASK_get()),
    USER_TYPE_MASK_LIMIT(OgreJNI.SceneManager_USER_TYPE_MASK_LIMIT_get());

    public final int swigValue() {
      return swigValue;
    }

    public static QueryTypeMask swigToEnum(int swigValue) {
      QueryTypeMask[] swigValues = QueryTypeMask.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (QueryTypeMask swigEnum : swigValues)
        if (swigEnum.swigValue == swigValue)
          return swigEnum;
      throw new IllegalArgumentException("No enum " + QueryTypeMask.class + " with value " + swigValue);
    }

    @SuppressWarnings("unused")
    private QueryTypeMask() {
      this.swigValue = SwigNext.next++;
    }

    @SuppressWarnings("unused")
    private QueryTypeMask(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private QueryTypeMask(QueryTypeMask swigEnum) {
  ...
  public enum IlluminationRenderStage {
    ...
    public static IlluminationRenderStage swigToEnum(int swigValue) {
      IlluminationRenderStage[] swigValues = IlluminationRenderStage.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (IlluminationRenderStage swigEnum : swigValues)
        if (swigEnum.swigValue == swigValue)
          return swigEnum;
    ...
    @SuppressWarnings("unused")
    private IlluminationRenderStage() {
      this.swigValue = SwigNext.next++;
    }

    @SuppressWarnings("unused")
    private IlluminationRenderStage(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private IlluminationRenderStage(IlluminationRenderStage swigEnum) {
      this.swigValue = swigEnum.swigValue;
      SwigNext.next = this.swigValue+1;
    }
  ...
  public enum SpecialCaseRenderQueueMode {
    ...
    public static SpecialCaseRenderQueueMode swigToEnum(int swigValue) {
      SpecialCaseRenderQueueMode[] swigValues = SpecialCaseRenderQueueMode.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (SpecialCaseRenderQueueMode swigEnum : swigValues)
        if (swigEnum.swigValue == swigValue)
          return swigEnum;
    ...
    @SuppressWarnings("unused")
    private SpecialCaseRenderQueueMode() {
      this.swigValue = SwigNext.next++;
    }

    @SuppressWarnings("unused")
    private SpecialCaseRenderQueueMode(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private SpecialCaseRenderQueueMode(SpecialCaseRenderQueueMode swigEnum) {
      this.swigValue = swigEnum.swigValue;
      SwigNext.next = this.swigValue+1;
    }
  ...
  public enum PrefabType {
    ...
    public static PrefabType swigToEnum(int swigValue) {
      PrefabType[] swigValues = PrefabType.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (PrefabType swigEnum : swigValues)
        if (swigEnum.swigValue == swigValue)
          return swigEnum;
    ...
    @SuppressWarnings("unused")
    private PrefabType(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private PrefabType(PrefabType swigEnum) {
      this.swigValue = swigEnum.swigValue;
      SwigNext.next = this.swigValue+1;
    }
