...
public class VertexDeclaration {
  ...
  public SWIGTYPE_p_std__listT_Ogre__VertexElement_t getElements() {
    return new SWIGTYPE_p_std__listT_Ogre__VertexElement_t(OgreJNI.VertexDeclaration_getElements(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__listT_Ogre__VertexElement_t findElementsBySource(int source) {
    return new SWIGTYPE_p_std__listT_Ogre__VertexElement_t(OgreJNI.VertexDeclaration_findElementsBySource(swigCPtr, this, source), true);
  }
