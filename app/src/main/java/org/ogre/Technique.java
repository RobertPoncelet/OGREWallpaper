...
public class Technique {
  ...
  public void setColourWriteEnabled(boolean enabled) {
    OgreJNI.Technique_setColourWriteEnabled__SWIG_0(swigCPtr, this, enabled);
  }

  public void setColourWriteEnabled(boolean red, boolean green, boolean blue, boolean alpha) {
    OgreJNI.Technique_setColourWriteEnabled__SWIG_1(swigCPtr, this, red, green, blue, alpha);
  }
  ...
  public boolean applyTextureAliases(NameValuePairList aliasList, boolean apply) {
    return OgreJNI.Technique_applyTextureAliases__SWIG_0(swigCPtr, this, NameValuePairList.getCPtr(aliasList), aliasList, apply);
  }

  public boolean applyTextureAliases(NameValuePairList aliasList) {
    return OgreJNI.Technique_applyTextureAliases__SWIG_1(swigCPtr, this, NameValuePairList.getCPtr(aliasList), aliasList);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__Technique__GPUVendorRule_t getGPUVendorRules() {
    return new SWIGTYPE_p_std__vectorT_Ogre__Technique__GPUVendorRule_t(OgreJNI.Technique_getGPUVendorRules(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__Technique__GPUDeviceNameRule_t getGPUDeviceNameRules() {
    return new SWIGTYPE_p_std__vectorT_Ogre__Technique__GPUDeviceNameRule_t(OgreJNI.Technique_getGPUDeviceNameRules(swigCPtr, this), false);
  }
  ...
  public enum IncludeOrExclude {
    INCLUDE(OgreJNI.Technique_INCLUDE_get()),
    EXCLUDE(OgreJNI.Technique_EXCLUDE_get());
    ...
    public static IncludeOrExclude swigToEnum(int swigValue) {
      IncludeOrExclude[] swigValues = IncludeOrExclude.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (IncludeOrExclude swigEnum : swigValues)
    ...
    @SuppressWarnings("unused")
    private IncludeOrExclude(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private IncludeOrExclude(IncludeOrExclude swigEnum) {
