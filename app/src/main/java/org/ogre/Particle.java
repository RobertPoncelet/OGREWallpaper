...
public class Particle {
  ...
  public enum ParticleType {
    ...
    public static ParticleType swigToEnum(int swigValue) {
      ParticleType[] swigValues = ParticleType.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (ParticleType swigEnum : swigValues)
    ...
    @SuppressWarnings("unused")
    private ParticleType(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private ParticleType(ParticleType swigEnum) {
