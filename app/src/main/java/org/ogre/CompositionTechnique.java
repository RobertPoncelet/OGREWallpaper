...
public class CompositionTechnique {
  ...
  static public class TextureDefinition {
    ...
    public void setFormatList(SWIGTYPE_p_std__vectorT_Ogre__PixelFormat_t value) {
      OgreJNI.CompositionTechnique_TextureDefinition_formatList_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__PixelFormat_t.getCPtr(value));
    }
  
    public SWIGTYPE_p_std__vectorT_Ogre__PixelFormat_t getFormatList() {
      long cPtr = OgreJNI.CompositionTechnique_TextureDefinition_formatList_get(swigCPtr, this);
      return (cPtr == 0) ? null : new SWIGTYPE_p_std__vectorT_Ogre__PixelFormat_t(cPtr, false);
    }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__CompositionTechnique__TextureDefinition_p_t getTextureDefinitions() {
    return new SWIGTYPE_p_std__vectorT_Ogre__CompositionTechnique__TextureDefinition_p_t(OgreJNI.CompositionTechnique_getTextureDefinitions(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_std__vectorT_Ogre__CompositionTargetPass_p_t getTargetPasses() {
    return new SWIGTYPE_p_std__vectorT_Ogre__CompositionTargetPass_p_t(OgreJNI.CompositionTechnique_getTargetPasses(swigCPtr, this), false);
  }
  ...
  public enum TextureScope {
    ...
    public static TextureScope swigToEnum(int swigValue) {
      TextureScope[] swigValues = TextureScope.class.getEnumConstants();
      if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
        return swigValues[swigValue];
      for (TextureScope swigEnum : swigValues)
    ...
    @SuppressWarnings("unused")
    private TextureScope(int swigValue) {
      this.swigValue = swigValue;
      SwigNext.next = swigValue+1;
    }

    @SuppressWarnings("unused")
    private TextureScope(TextureScope swigEnum) {
