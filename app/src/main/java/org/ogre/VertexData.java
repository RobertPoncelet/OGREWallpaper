...
public class VertexData {
  ...
  public void setHwAnimationDataList(SWIGTYPE_p_std__vectorT_Ogre__VertexData__HardwareAnimationData_t value) {
    OgreJNI.VertexData_hwAnimationDataList_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_Ogre__VertexData__HardwareAnimationData_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorT_Ogre__VertexData__HardwareAnimationData_t getHwAnimationDataList() {
    long cPtr = OgreJNI.VertexData_hwAnimationDataList_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_std__vectorT_Ogre__VertexData__HardwareAnimationData_t(cPtr, false);
  }
  ...
  public void reorganiseBuffers(VertexDeclaration newDeclaration, SWIGTYPE_p_std__vectorT_Ogre__HardwareBuffer__Usage_t bufferUsage, HardwareBufferManagerBase mgr) {
    OgreJNI.VertexData_reorganiseBuffers__SWIG_0(swigCPtr, this, VertexDeclaration.getCPtr(newDeclaration), newDeclaration, SWIGTYPE_p_std__vectorT_Ogre__HardwareBuffer__Usage_t.getCPtr(bufferUsage), HardwareBufferManagerBase.getCPtr(mgr), mgr);
  }
  ...
  public void reorganiseBuffers(VertexDeclaration newDeclaration, SWIGTYPE_p_std__vectorT_Ogre__HardwareBuffer__Usage_t bufferUsage) {
    OgreJNI.VertexData_reorganiseBuffers__SWIG_1(swigCPtr, this, VertexDeclaration.getCPtr(newDeclaration), newDeclaration, SWIGTYPE_p_std__vectorT_Ogre__HardwareBuffer__Usage_t.getCPtr(bufferUsage));
  }
