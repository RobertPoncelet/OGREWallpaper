...
public class Quaternion {
  ...
  public Quaternion(Quaternion rhs) {
    this(OgreJNI.new_Quaternion__SWIG_1(Quaternion.getCPtr(rhs), rhs), true);
  }

  public Quaternion(float fW, float fX, float fY, float fZ) {
    this(OgreJNI.new_Quaternion__SWIG_2(fW, fX, fY, fZ), true);
  }

  public Quaternion(Matrix3 rot) {
    this(OgreJNI.new_Quaternion__SWIG_3(Matrix3.getCPtr(rot), rot), true);
  }

  public Quaternion(Radian rfAngle, Vector3 rkAxis) {
    this(OgreJNI.new_Quaternion__SWIG_4(Radian.getCPtr(rfAngle), rfAngle, Vector3.getCPtr(rkAxis), rkAxis), true);
  }

  public Quaternion(Vector3 xaxis, Vector3 yaxis, Vector3 zaxis) {
    this(OgreJNI.new_Quaternion__SWIG_5(Vector3.getCPtr(xaxis), xaxis, Vector3.getCPtr(yaxis), yaxis, Vector3.getCPtr(zaxis), zaxis), true);
  }

  public Quaternion(Vector3 akAxis) {
    this(OgreJNI.new_Quaternion__SWIG_6(Vector3.getCPtr(akAxis), akAxis), true);
  }

  public Quaternion(SWIGTYPE_p_float valptr) {
    this(OgreJNI.new_Quaternion__SWIG_7(SWIGTYPE_p_float.getCPtr(valptr)), true);
  }
  ...
  public Quaternion __add__(Quaternion rkQ) {
    return new Quaternion(OgreJNI.Quaternion___add__(swigCPtr, this, Quaternion.getCPtr(rkQ), rkQ), true);
  }

  public Quaternion __sub__(Quaternion rkQ) {
    return new Quaternion(OgreJNI.Quaternion___sub____SWIG_0(swigCPtr, this, Quaternion.getCPtr(rkQ), rkQ), true);
  }

  public Quaternion __mul__(Quaternion rkQ) {
    return new Quaternion(OgreJNI.Quaternion___mul____SWIG_0(swigCPtr, this, Quaternion.getCPtr(rkQ), rkQ), true);
  }

  public Quaternion __mul__(float s) {
    return new Quaternion(OgreJNI.Quaternion___mul____SWIG_1(swigCPtr, this, s), true);
  }

  public Quaternion __sub__() {
    return new Quaternion(OgreJNI.Quaternion___sub____SWIG_1(swigCPtr, this), true);
  }
  ...
  public Vector3 __mul__(Vector3 rkVector) {
    return new Vector3(OgreJNI.Quaternion___mul____SWIG_2(swigCPtr, this, Vector3.getCPtr(rkVector), rkVector), true);
  }
